...
FILE_PATH = "data/BSN-MSN NCLEX Pass Rates.xlsx"
...
fig.update_layout(
    ...
    title=f"BSN-MSN NCLEX Pass Rate - {selected_year}",
    geo=dict(
        fitbounds="locations",
        visible=True,
        scope="usa",
...
# ========== DISPLAY ==========
st.title("BSN-MSN NCLEX Pass Rates of schools in Tennessee (2020–2024)")
